...
[COLEMAK_DH] = LAYOUT_ansi_87(
     ...
     KC_CAPS,  LT(ALT, KC_A),    KC_R,     KC_S,     KC_T,     KC_G,     KC_M,     KC_N,     KC_E,     KC_I,     KC_O,     KC_QUOT,            KC_ENT,
     KC_LSFT,                    KC_X,     KC_C,     KC_D,     KC_V,     KC_Z,     KC_K,     KC_H,     KC_COMM,  KC_DOT,   KC_SLSH,            KC_RSFT,             KC_UP,
     KC_LCTL,  KC_LGUI,          KC_LALT,                      KC_SPC,                                 KC_RALT,  KC_RGUI, TG(ALT),   KC_RCTL,  KC_LEFT,  KC_DOWN,  KC_RGHT),

[ALT] = LAYOUT_ansi_87(
     KC_TRNS,  KC_BRID,  KC_BRIU,  KC_TASK,  KC_FILE,  RGB_VAD,  RGB_VAI,  KC_MPRV,  KC_MPLY,  KC_MNXT,  KC_MUTE,  KC_VOLD,  KC_VOLU,            KC_TRNS,  QK_BOOT,  RGB_TOG,
     ...
     KC_TRNS,  RGB_RMOD, RGB_VAD,  RGB_HUD,  RGB_SAD,  RGB_SPD,  KC_LEFT,  KC_DOWN,  KC_UP,    KC_RIGHT, KC_TRNS,  KC_TRNS,            KC_TRNS,
...
[QWERTY] = LAYOUT_ansi_87(
     ...
     KC_CAPS,  LT(ALT, KC_A),     KC_S,     KC_D,     KC_F,     KC_G,     KC_H,     KC_J,     KC_K,     KC_L,     KC_SCLN,  KC_QUOT,            KC_ENT,
